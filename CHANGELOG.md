...
- Update constraint on `PyNaCl` from `1.2.1` to `1.6.2` to resolve CVE https://github.com/advisories/GHSA-mrfv-m5wm-5w6w
- Update constraint on `pytest` from `4.2.1` to `9.0.3` to resolve CVE https://github.com/advisories/GHSA-6w46-j5rx-g56g
